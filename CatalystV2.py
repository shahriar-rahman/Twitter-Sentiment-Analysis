...
class SentimentApp:
    ...
    def MainMenu(self): #MENU WITH ALL OPTIONS
        ...
        ButtonSelection1.place(relx="0.130", rely="0.280");
        ...
        ButtonSelection2.place(relx="0.138", rely="0.685");
        ...
        ButtonSelection3.place(relx="0.745", rely="0.280");
        ...
        ButtonSelection4.place(relx="0.736", rely="0.702");
        ...
        ButtonSelection5.place(relx="0.448", rely="0.694");
...
########
        ...
        #####NEED TO ADD FEW LINES TO IMPROVE
        if "ok" in TextSentence or "okay" in TextSentence or "alright" in TextSentence and "not" in TextSentence or "don't" in TextSentence or "do not" in TextSentence:
            polarity = -0.4;
            print("Polarity :");
            print(polarity);
        elif "good" in TextSentence and "not" in TextSentence or "don't" in TextSentence or "do not" in TextSentence:
            polarity = -0.522;
            print("Polarity :");
            print(polarity);
        elif "well" in TextSentence and "not" in TextSentence or "don't" in TextSentence or "do not" in TextSentence:
            polarity = -1 * (0.60) * 0.75;
            print("Polarity :");
            print(polarity);
        elif "great" in TextSentence and "not" in TextSentence or "don't" in TextSentence or "do not" in TextSentence:
            polarity = -0.60;
            print("Polarity :");
            print(polarity);
        elif "awesome" in TextSentence and "not" in TextSentence or "don't" in TextSentence or "do not" in TextSentence:
            polarity = -1 * 0.85 * 0.25;
            print("Polarity :");
            print(polarity);
        elif "dislike" in TextSentence or "disliked" in TextSentence:
            polarity = -0.60;
            print("Polarity :");
            print(polarity);
        elif "depressed" in TextSentence or "depression" in TextSentence or "very depressed" in TextSentence or "huge depression" in TextSentence:
            polarity = -0.80;
            print("Polarity :");
            print(polarity);
        elif "well" in TextSentence:
            polarity = 0.60;
            print("Polarity :");
            print(polarity);
            # EOL
    ...
    def AnalysisGraphSelection1(self):
        ...
        with open('LexiconResults.txt', mode='r') as csv_file:
            ...
            sizes = [SPositivePercent,PositivePercent,WPositivePercent,
                     SNegativePercent,
                     NegativePercent,
                     WNegativePercent,
                     NeutralPercent];
    ...
    def AnalyzeTwitterPosts(self):
        ...
        for tweet in self.tweets:
            ...
            ##BUG FIXING
            if "ok" in tweet.text or "okay" in tweet.text or "alright" in tweet.text and "not" in tweet.text or "don't" in tweet.text or "do not" in tweet.text:
                polarity = -0.4;
                print("Polarity :");
                print(polarity);
            elif "good" in tweet.text and "not" in tweet.text or "don't" in tweet.text or "do not" in tweet.text:
                polarity = -0.522;
                print("Polarity :");
                print(polarity);
            elif "well" in tweet.text and "not" in tweet.text or "don't" in tweet.text or "do not" in tweet.text:
                polarity = -1 * (0.60) * 0.75;
                print("Polarity :");
                print(polarity);
            elif "great" in tweet.text and "not" in tweet.text or "don't" in tweet.text or "do not" in tweet.text:
                polarity = -0.60;
                print("Polarity :");
                print(polarity);
            elif "awesome" in tweet.text and "not" in tweet.text or "don't" in tweet.text or "do not" in tweet.text:
                polarity = -1 * 0.85 * 0.25;
                print("Polarity :");
                print(polarity);
            elif "dislike" in tweet.text or "disliked" in tweet.text:
                polarity = -0.60;
                print("Polarity :");
                print(polarity);
            elif "depressed" in tweet.text or "depression" in tweet.text or "very depressed" in tweet.text or "huge depression" in tweet.text:
                polarity = -0.80;
                print("Polarity :");
                print(polarity);
            elif "well" in tweet.text:
                polarity = 0.60;
                print("Polarity :");
                print(polarity);
                # EOL
    ...
    def ViewAllTweets(self):
        ...
        BgImages.pack();
        self.ViewAllTweetsWindow.mainloop(); #def DisplayTweetResults(self):
