...
class SentimentApp:
    ...
    def MainMenu(self): #MENU WITH ALL OPTIONS
        ...
        ButtonSelection3.place(relx="0.6055", rely="0.848");
        #ButtonSelection1 = Button(self.MainMenuWindow, image=ImgButton1, command=self.AnalyzeSentenceAction);
    ...
    def AnalyzeSentenceProcess(self):   #GET OR RECIVER OUTPUT WINDOW
        ...
        polarity = 0; neutral = 0; positive = 0; negative = 0
        ...
        if (neutral>positive and neutral>negative):
            ...
            LabelSentenceResult = Label(self.AnalyzeSentenceProcessWindow,text="The Lexical Analysis Result returns Positive", bg="#0053B1", fg="White", font=("Agency FB bold", 18), width="78", height="1")
            LabelSentenceResult.place(relx="0.0015", rely="0.435");
        elif (negative>neutral and negative>positive):
            LabelSentenceResult = Label(self.AnalyzeSentenceProcessWindow,text="The Lexical Analysis Result returns Negative", bg="#0053B1", fg="White", font=("Agency FB bold", 18), width="78", height="1")
            LabelSentenceResult.place(relx="0.0015", rely="0.435");
    ...
    def AnalysisGraphSelection1(self):
        ...
        with open('LexiconResults.txt', mode='r') as csv_file:
            ...
            iteration = 0; positive = 0; negative = 0; neutral = 0;
    ...
    def AnalysisViewHistory(self):
        ...
        self.AnalysisViewHistoryWindow.geometry("600x300");
        photoImages = PhotoImage(file="#10.png", master=self.AnalysisViewHistoryWindow);
        ...
        with open('LexiconHistory.txt', mode='r') as csv_file:
            ...
            if(iteration==1):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
            elif (iteration == 2):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
            elif (iteration == 3):
                TestLabel0=Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration-1], bg="#0484E4", fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1=Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration-2], bg="#0484E4", fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
            elif (iteration == 4):
                TestLabel0=Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration-1], bg="#0484E4", fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1=Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration-2], bg="#0484E4", fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                TestLabel3 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 4], bg="#0484E4",fg="white");TestLabel3.place(relx="0.0095", rely="0.305");
            elif (iteration == 5):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                TestLabel3 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 4], bg="#0484E4",fg="white");TestLabel3.place(relx="0.0095", rely="0.305");
                TestLabel4 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 5], bg="#0484E4",fg="white");TestLabel4.place(relx="0.0095", rely="0.355");
            elif (iteration == 6):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                TestLabel3 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 4], bg="#0484E4",fg="white");TestLabel3.place(relx="0.0095", rely="0.305");
                TestLabel4 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 5], bg="#0484E4",fg="white");TestLabel4.place(relx="0.0095", rely="0.355");
                TestLabel5 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 6], bg="#0484E4",fg="white");TestLabel5.place(relx="0.0095", rely="0.405");
            elif (iteration == 7):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                ...
                TestLabel4 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 5], bg="#0484E4",fg="white");TestLabel4.place(relx="0.0095", rely="0.355");
                TestLabel5 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 6], bg="#0484E4",fg="white");TestLabel5.place(relx="0.0095", rely="0.405");
                TestLabel6 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 7], bg="#0484E4",fg="white");TestLabel6.place(relx="0.0095", rely="0.455");
            elif (iteration == 8):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                ...
                TestLabel5 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 6], bg="#0484E4",fg="white");TestLabel5.place(relx="0.0095", rely="0.405");
                TestLabel6 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 7], bg="#0484E4",fg="white");TestLabel6.place(relx="0.0095", rely="0.455");
                TestLabel7 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 8], bg="#0484E4",fg="white");TestLabel7.place(relx="0.0095", rely="0.505");
            elif (iteration == 9):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                ...
                TestLabel6 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 7], bg="#0484E4",fg="white");TestLabel6.place(relx="0.0095", rely="0.455");
                TestLabel7 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 8], bg="#0484E4",fg="white");TestLabel7.place(relx="0.0095", rely="0.505");
                TestLabel8 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 8], bg="#0484E4",fg="white");TestLabel8.place(relx="0.0095", rely="0.505");
            elif (iteration == 10):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                ...
                TestLabel6 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 7], bg="#0484E4",fg="white");TestLabel6.place(relx="0.0095", rely="0.455");
                TestLabel7 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 8], bg="#0484E4",fg="white");TestLabel7.place(relx="0.0095", rely="0.505");
                TestLabel8 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 9], bg="#0484E4",fg="white");TestLabel8.place(relx="0.0095", rely="0.555");
                TestLabel9 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 10], bg="#0484E4",fg="white");TestLabel9.place(relx="0.0095", rely="0.605");
            elif (iteration == 11):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                ...
                TestLabel8 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 9], bg="#0484E4",fg="white");TestLabel8.place(relx="0.0095", rely="0.555");
                TestLabel9 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 10], bg="#0484E4",fg="white");TestLabel9.place(relx="0.0095", rely="0.605");
                TestLabel10 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 11], bg="#0484E4",fg="white");TestLabel10.place(relx="0.0095", rely="0.655");
            elif (iteration == 12):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                ...
                TestLabel9 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 10], bg="#0484E4",fg="white");TestLabel9.place(relx="0.0095", rely="0.605");
                TestLabel10 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 11], bg="#0484E4",fg="white");TestLabel10.place(relx="0.0095", rely="0.655");
                TestLabel11 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 12], bg="#0484E4",fg="white");TestLabel11.place(relx="0.0095", rely="0.705");
            elif (iteration == 13):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                ...
                TestLabel10 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 11], bg="#0484E4",fg="white");TestLabel10.place(relx="0.0095", rely="0.655");
                TestLabel11 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 12], bg="#0484E4",fg="white");TestLabel11.place(relx="0.0095", rely="0.705");
                TestLabel12 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 13], bg="#0484E4",fg="white");TestLabel12.place(relx="0.0095", rely="0.755");
            elif (iteration == 14):
                TestLabel0 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 1], bg="#0484E4",fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 2], bg="#0484E4",fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4",fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                ...
                TestLabel11 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 12], bg="#0484E4",fg="white");TestLabel11.place(relx="0.0095", rely="0.705");
                TestLabel12 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 13], bg="#0484E4",fg="white");TestLabel12.place(relx="0.0095", rely="0.755");
                TestLabel13 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 14], bg="#0484E4",fg="white");TestLabel13.place(relx="0.0095", rely="0.805");
            else :
                TestLabel0=Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration-1], bg="#0484E4", fg="white");TestLabel0.place(relx="0.0095", rely="0.135");
                TestLabel1=Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration-2], bg="#0484E4", fg="white");TestLabel1.place(relx="0.0095", rely="0.205");
                TestLabel2 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 3], bg="#0484E4", fg="white");TestLabel2.place(relx="0.0095", rely="0.255");
                ...
                TestLabel12 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 13], bg="#0484E4", fg="white");TestLabel12.place(relx="0.0095", rely="0.755");
                TestLabel13 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 14], bg="#0484E4", fg="white");TestLabel13.place(relx="0.0095", rely="0.805");
                TestLabel14 = Label(self.AnalysisViewHistoryWindow, text=ArrayFetch[iteration - 15], bg="#0484E4", fg="white");TestLabel14.place(relx="0.0095", rely="0.855");
    ...
    def AnalyzeTwitterPosts(self):
        ...
        self.ButtonViewTweets = Button(self.AnalysisTwitterWindow, text="View Tweets", bg="#001745",fg="#00BAFF", font=("Agency FB bold", 17), width="20",command=quit);
